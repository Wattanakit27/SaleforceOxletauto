...
# ★ ส.ค.69 (เจ้าของสั่ง) — ธงที่ "ปลดออกเฉยๆ ไม่ได้ ต้องมีหลักฐาน"
#   เจ้าของ: "ถ้าติ๊ก ยังไม่ถ่ายรูป ออก ต้องใส่รูปที่ถ่ายแล้ว กับหมายเหตุด้วย"
#   → ปลดธงนี้ = ประกาศว่า "ถ่ายเสร็จแล้ว" ต้องแนบรูปที่ถ่าย + โน้ต แล้วระบบเก็บลงไทม์ไลน์ให้
#   (ติ๊ก "กลับเข้า" ไม่ต้องมีหลักฐาน — แค่บอกว่ายังค้างอยู่)
#   เพิ่ม need_content / need_tire ตรงนี้ได้ถ้าอยากบังคับเหมือนกัน
FLAG_PROOF_REQUIRED = {"need_photo"}
# ชื่อ "ตอนงานเสร็จ" ของแต่ละธง — ใช้เขียนลงไทม์ไลน์ให้อ่านรู้เรื่อง
# (ถ้าใช้ชื่อธงตรงๆ จะได้ประโยคขัดกันเอง เช่น "เสร็จแล้ว: ยังไม่ได้ถ่ายรูป")
FLAG_DONE_NAME = {"need_photo": "ถ่ายรูปรถเสร็จแล้ว",
                  "need_content": "ถ่ายคอนเทนต์เสร็จแล้ว",
                  "need_tire": "เปลี่ยนยางเสร็จแล้ว"}
