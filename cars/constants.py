...
#   ★ เจ้าของเคาะรายสเตปเอง (ส.ค.69) — ตัด ซ่อม/เบาะ/อะไหล่/สีทั้งหมด/รอ QC ตรวจ ออก
#   เหลือเฉพาะงานที่ "จัดคิวแล้วเร่งได้จริง" (ถ่ายรูป/ฟิล์ม/ล้าง) + ตอนรับเข้า
PRIORITY_STAGES = {
    "intake",        # รับเข้า — มาร์คได้ตั้งแต่รับรถว่าคันนี้ต้องรีบ
    "photo_wait",    # รถรอถ่ายรูป — ทีมคอนเทนต์มีคิวถ่ายหลายคัน
    "film",          # ติดฟิล์ม
    "wash",          # ชงล้าง
    "wash_release",  # ชงล้างรอปล่อย (ตั้ง "ด่วนมาก" ให้เองอยู่แล้ว — ดู STAGE_AUTO_PRIORITY)
}
