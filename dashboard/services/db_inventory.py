...
TABLES = {
    ...
    "dash_purchase_case": dict(
        name="เคสรับซื้อ/เทิร์นรถ",
        what="เคสที่ลูกค้าเสนอขาย/เทิร์นรถเข้ามาทางกลุ่ม LINE — รุ่นรถ · ทะเบียน · "
             "ชื่อ+เบอร์ผู้ขาย · ช่องทาง · คนจัดซื้อที่ดูแล · ผลรับซื้อ/ไม่รับซื้อ "
             "(ย้ายมาจากชีต 'ซื้อขายเทิร์นรถ' 17 ก.ย.69 · n8n เขียนเข้ามา)",
        pii=True, keep="เก็บถาวร (เป็นประวัติการรับซื้อ)"),
