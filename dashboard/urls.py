...
urlpatterns = [
    ...
    path("api/admin/live_session", views.admin_live_session, name="admin_live_session"),
    path("api/admin/report_test", views.admin_report_test, name="admin_report_test"),
    path("api/admin/leadsummary_config", views.admin_leadsummary_config, name="admin_leadsummary_config"),
    path("api/admin/leadsummary_test", views.admin_leadsummary_test, name="admin_leadsummary_test"),
    path("api/admin/card_line_config", views.admin_card_line_config, name="admin_card_line_config"),
    path("api/admin/card_line_test", views.admin_card_line_test, name="admin_card_line_test"),
