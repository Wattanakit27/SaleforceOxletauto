...
## 13.1) เก็บรูป/วิดีโอลง Google Drive (ออปชั่น — ไม่ตั้งก็ได้)

**ค่าเริ่มต้น = เก็บลงดิสก์ VPS** (`/opt/oxlet/media/` · nginx เสิร์ฟ `/media/`) — รูป/วิดีโอขึ้นทันที
ไม่ต้องตั้งบริการนอก. ทำขั้นนี้ก็ต่อเมื่ออยากเก็บบน Google Drive แทน (สำรอง/พื้นที่เยอะ)

ถ้าจะใช้ Google Drive: เก็บลง Drive ของ `oxletauto@gmail.com` (พื้นที่ Google One)
...
> ไม่ตั้ง GDRIVE_* = เก็บลงดิสก์ VPS แทน (`/media/`) — ใช้งานได้ปกติ
