"""ดู/ตั้งค่า "ดักเก็บข้อมูลจากกลุ่ม LINE" จากบรรทัดคำสั่ง (ไม่ต้องเปิดเว็บ)
    ...
    python manage.py checkout_config --reply on               # เปิดให้ตอบแชทลูกค้าจริง
...
_FLAGS = [("store_chat", "store_chat", "เก็บแชทกลุ่ม"),
          ...
          # ★ ก.ย.69 — ปิดโดยปริยาย (เจ้าของสั่ง "อย่าเพิ่งส่งข้อความอะไรหาลูกค้า")
          ("reply", "reply_customer", "ตอบแชทลูกค้าจากหน้าเว็บ (ส่งออกจริง)")]
