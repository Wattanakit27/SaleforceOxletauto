...
- **★ ขยาย/สมดุลฟอนต์รูปรายงาน (ส.ค.69 ปรับ 2 รอบตาม feedback)**: `#rpt-shot` — **หัวตาราง/ตัวหนังสือใหญ่ขึ้น** (หัวหลัก 24 หัวรอง 21 ชื่อเซลล์ 27 ป้ายทีม 16 subtitle 25) **ตัวเลขลดลง** (หลัก 30 รอง 26 · เคยดัน 36/30 แล้วผู้ใช้บอกเลขใหญ่ไป-หนังสือเล็กไป) กล่อง 118/84px · `#rpt-shot-teams` ตาราง 19 หัว 17-18 — กว้างรวมไม่เกิน 1560/1120px
