...
3. **🧹 ข้อมูลต้องเติม/แก้** (`renderDataQualityPanel()`) — dashboard ให้ admin ตามไปเติมข้อมูลในชีต
   - **วันปล่อยว่าง**: status="ปล่อย" แต่ไม่มีวันปล่อย → **กรองตามช่วงวันที่ (วันจอง)** · กระทบคะแนนเวลาปิดดีล + การนับเดือน
   - **ปีผิด**: ช่องวันที่ (จอง/เซ็น/ผล/ปล่อย) มีปีนอก 2020–2035 (มักพิมพ์ 1969) → **แสดงทุกเคส ไม่กรอง** (เพราะวันที่คือตัวที่ผิด กรองไม่ได้)
