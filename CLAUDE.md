...
- **📄 [deploy/n8n_members_postgres.json](deploy/n8n_members_postgres.json)** — **1 โหนด** ก๊อปวางบน canvas
  แทนโหนดชีต **`Get Members (Master)`** (แท็บ `รายชื่อสมาชิกกลุ่ม` ของไฟล์ `ซื้อขายเทิร์นรถ`)
